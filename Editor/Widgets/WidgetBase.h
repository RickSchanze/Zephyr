...
public:
     ...
     * @param name widget名称
     */
    WidgetBase(std::string name, bool visible, bool is_draw_as_window)
        : m_name(std::move(name)), m_visible(visible), m_is_draw_as_window(is_draw_as_window)
    {
        s_widget_count++;
    }
     ...
     * @param name widget名称
     */
    WidgetBase(std::string name, bool visible) : WidgetBase(std::move(name), visible, false)
    {
    }
     ...
     * @param name widget名称
     */
    explicit WidgetBase(std::string name) : WidgetBase(std::move(name), true, false)
    {
    }

    /** 默认构造 */
    WidgetBase() : WidgetBase(std::format("Widget{}", s_widget_count))
    {
    }
